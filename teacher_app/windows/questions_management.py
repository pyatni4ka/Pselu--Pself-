...
class QuestionsManagement(QWidget):
    ...
    def init_ui(self):
        ...
        self.combo_filter.addItem("графики")
        self.combo_filter.addItem("практика")
        self.combo_filter.addItem("теория")
        ...
        self.table.setHorizontalHeaderLabels(["Вопрос", "Тип вопроса", "Правильный ответ", "ID"])
